...
public class TestServiceImpl implements ITestService {
    ...
    public static String getCurrentClasspath() {
        ...
        String currentClasspath = ClassUtils.getDefaultClassLoader().getResource("").getPath();
        ...
        return currentClasspath.substring(0, currentClasspath.length() - 8) + File.separator + "datax-service";
    }
}
